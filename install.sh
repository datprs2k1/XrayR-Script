...
install_XrayR() {
	...
	echo ""
        wget -N --no-check-certificate -O /usr/local/XrayR/XrayR-linux.zip https://github.com/datprs2k1/XrayR-Script/releases/download/${last_version}/XrayR-linux-${arch}.zip
        if [[ $? -ne 0 ]]; then
	echo ""
